...
import './LeftAlign.scss'
import { AlignLeftIcon } from '../Icons/Icons';
...
const LeftAlign: React.FC<LeftAlignProps> = ({
  editorRef,
  // lastSelection,
  saveSelection,
  restoreSelection,
  ...
  return (
    <button 
      ...
      title="Left Align"
    >
     <AlignLeftIcon height={28} width={28} className='AlignLeftIcon'/>
    </button>
  );
};
